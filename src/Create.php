...
class Create extends Push
{
	...
	public function execute(\PDO $database): bool
	{
		...
		if($superType !== null && ($superTypeSchema = Schema::getSchema($superType))) { // is subType of $superType
